...
<?php if ($include_static_map) : ?>
  <?php $static_w = (int) $width; ?>
  <?php $static_h = (int) $height; ?>
  <?php $static_w = 300; ?>
  <?php $static_h = 300; ?>
  <div class="simple-gmap-static-map hidden-sm hidden-md hidden-lg">
    <a href="https://maps.google.com/maps?q=<?php print $url_suffix; ?>&amp;hl=<?php print $langcode; ?>&amp;iwloc=<?php print ($information_bubble ? 'A': 'near'); ?>&amp;z=<?php print $zoom; ?>&amp;t=<?php print $map_type; ?>" target="_blank">
      <img class="img-responsive" src="http://maps.googleapis.com/maps/api/staticmap?size=<?php print $static_w; ?>x<?php print $static_h; ?>&amp;zoom=<?php print $zoom; ?>&amp;language=<?php print $langcode; ?>&amp;maptype=<?php print $static_map_type; ?>&amp;markers=color:red|<?php print $url_suffix; ?>&amp;sensor=false?" />
    </a>
  </div>
<?php endif;?>
<?php if ($include_link) : ?>
