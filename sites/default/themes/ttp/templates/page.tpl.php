...
<div class="wrapper-content">
  <div class="main-container container">
    ...
    <?php if (!empty($top_title) || !empty($top_description)) : ?> 
      <div class="row">
        <div class="col-md-12">
          <?php if (!empty($top_title)) : ?> 
            <h1 class="text-center"><?php print $top_title; ?></h1>
            <div class="scroll-home-separator"></div>
          <?php endif; ?>

          <?php print render($top_subtitle); ?>
          <?php print render($top_description); ?>
    ...
    <div class="row row-main-content">
      ...
      <section<?php print $content_column_class; ?>>
        ...
        <?php //print render($title_prefix); ?>
          <?php //if(($is_page) && (!$is_front)) : ?>
            <?php //if (!empty($title)): ?>
              <?php //<h1 class="page-header text-center"><?php print $title; </h1> ?>
            <?php //endif; ?>
          <?php //endif; ?>
      ...
      <?php if (!empty($page['sidebar_second'])): ?>
        <aside <?php print $right_column_class; ?> role="complementary">
